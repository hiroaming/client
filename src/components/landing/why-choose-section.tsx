    ...
    <section className="container mx-auto">
      <div className="mb-12 text-center">
        ...
        <p className="mx-auto max-w-2xl text-muted-foreground">
          HiRoaming is built for modern travelers who want freedom, flexibility,
          and better value—without the usual roaming headaches.
        </p>
      </div>
        ...
        <div className="grid gap-4 lg:grid-cols-3">
            ...
            <div className="grid gap-8 lg:grid-cols-[1fr_1.6fr] lg:items-center">
              ...
              <div className="max-w-md">
                ...
                <p className="mt-6 text-base text-white/50">
                  Choose plans that fit your needs—daily, weekly, or custom data
                  options you can adjust anytime.
                </p>
              </div>
          ...
          <div className="rounded-2xl border border-border bg-white p-6 shadow-sm">
            ...
            <p className="mb-4 text-sm text-muted-foreground">
              Enjoy competitive eSIM plans designed to give you the best value,
            ...
            <div className="rounded-2xl bg-black p-5 text-white">
              ...
              <div className="flex items-end justify-between">
                ...
                <div className="flex items-end gap-2">
                  <div className="text-2xl text-white/40 line-through">$5</div>
          ...
          {/* Redeemable Points */}
          <div className="rounded-2xl border border-border bg-white p-6 shadow-sm">
            <div className="mb-4 text-2xl font-semibold">Redeemable Points</div>
            <p className="mb-4 text-sm text-muted-foreground">
              Earn points every time you top up and redeem them for discounts on
              your next data package.
            </p>
